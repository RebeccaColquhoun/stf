...
centers = [64,59,23,79,29,93]%randi(100, 1, numGaussians);
% Make widths in the range 0 - 20
sigmas = [6,11,7,5,11,3]%randi(20, 1, numGaussians);
% Make amplitudes in the range 0 - 40
amplitudes = [40,20,16,26,20,36]%randi([10, 40], 1, numGaussians);
...
% Run optimization
% this defines an anonamous function with no name which takes lambda and the contents of the funtion runs fitgauss on lamdba, tfit and y.
% this is because fminsearch can only deal with functions with one argument
