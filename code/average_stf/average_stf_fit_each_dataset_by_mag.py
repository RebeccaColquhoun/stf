...
for dataset_wanted in ['scardec_opt', 'scardec_moy', 'ye', 'usgs', 'sigloch', 'isc']:
	...
	for i, b in enumerate(boundaries):
		...
		plt.savefig(f'/home/earthquakes1/homes/Rebecca/phd/stf/figures/average_STF/average_observed_and_models_{dataset_wanted}_v2_{b}_{b+interval}.png')
		plt.close()

		with open(f'/home/earthquakes1/homes/Rebecca/phd/stf/figures/average_STF/average_best_fitting_models_dataset_{dataset_wanted}_v2.txt', 'a') as f:
			f.write(f'{dataset_wanted}\n')
			f.write(f'Magnitude {b} to {b+interval}\n')
			f.write(f'Gaussian \n')
